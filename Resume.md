...
- Working with the State's IT Department, created a Microsoft SharePoint website that is used as a information resource that allows for planners in the office to: reference internal procedures, gain quick access to the ever evolving fiscal guidelines, and to utilize online document storage that frees up space on the office's limited shared storage. 
